...
def insert_record(id, Date_Time, Product_Name,Count,Takt_time,start_time, end_time):
        query = "INSERT INTO a3 (id, Date_Time, Product_Name,Count,Takt_time,start_time, end_time) " \
    ...
    while True:
        ...
        if GPIO.input(17) == 1:
            ...
            if month_first_day <= date_today < month_last_day:
               csv_name = '/home/pi/Desktop/QtGUI/Database_pi/'+ str(month_first) +".csv"
            else:
               csv_name = '/home/pi/Desktop/QtGUI/Database_pi/'+ str(month_last) +".csv"  
